...
gene identifiers. Therefore, biomaRt bioconductor package will be used to convert probe 
identifiers from GPL570 platform to their corresponding Gene Symbol identifiers before 
analysis. Moreover, microarray platforms may contain more than one probe for the
same gene. This ambiguity will be removed by selecting probes with the highest mean of 
expression.

```{r}
library(biomaRt)
ensembl <- useMart("ensembl", dataset="hsapiens_gene_ensembl")
probes <- rownames(exp_matrix)
annottab <- getBM(attributes = c('affy_hg_u133_plus_2', 'hgnc_symbol'),
